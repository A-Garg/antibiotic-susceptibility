...
app_ui = ui.page_fluid(
    ...
    ui.layout_sidebar(
        ...
        sidebar=ui.panel_sidebar(
            ...
            ui.input_radio_buttons('Hospital','Hospital: currently pending data from TOH, so will not affect output',{0:'Sunnybrook',1:'TOH'},inline=True),
            ...
            ui.input_radio_buttons('Acquisition','Acquisition:',{0:'Community',1:'Hospital non-ICU',2:'ICU'},inline=True),
...
'''    
    ...
    def input_values():
        ...
        print(pd.DataFrame(regression_values,regression_inputs))        
        return(pd.DataFrame(regression_values,regression_inputs))
'''        
